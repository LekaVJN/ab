        ...
        >
          ...
          <div className="flex flex-col items-start gap-4 pt-2 sm:gap-5">
            <a
              ...
              className="inline-flex items-center justify-center rounded-full bg-[#58bcbf] px-6 py-3 text-center text-sm font-semibold leading-none text-slate-950 shadow-soft hover:bg-[#48a9a9]"
            >
              Обсудить подключение
            </a>
            <p className="max-w-lg text-lg font-medium leading-8 text-slate-100 sm:text-xl">
