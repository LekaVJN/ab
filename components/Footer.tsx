...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#08121f] text-slate-400">
        ...
        <div className="grid gap-8 md:grid-cols-[1.5fr_1fr] lg:grid-cols-[1.6fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-400">
              Профессиональный шеринг электровелосипедов для курьеров. Деловой и надежный формат сотрудничества.
            </p>
          </div>
