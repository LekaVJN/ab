...
export default function ContactSection() {
  return (
    <section id="contact" className="border-t border-white/10 bg-[#08121f]">
      <div className="container py-20">
        <div className="mx-auto grid gap-10 lg:grid-cols-[1.3fr_0.8fr] items-start">
          <motion.div
            ...
            className="space-y-8"
          >
            <p className="section-title">Начните сотрудничество сегодня</p>
            <h2 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              Свяжитесь для обсуждения парка велосипедов и условий аренды
            </h2>
            <p className="max-w-2xl text-base leading-8 text-slate-300">
              ИП Вьюнов А.В. предлагает прозрачный формат работы, удобную коммуникацию и стабильную поддержку курьерских
              служб и курьерских компаний.
            </p>
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                },
                {
                  ...
                  value: 'Кемеровская обл. – Кузбасс, г. Кемерово, ул. Дзержинского, д. 4А',
                  type: 'text',
                },
              ].map((item, index) => (
                <motion.div
          ...
          <motion.div
            ...
            className="rounded-[28px] border border-slate-200 bg-slate-950/80 p-8 shadow-soft"
          >
